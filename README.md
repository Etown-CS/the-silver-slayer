...
The site is intended to be hosted and viewed on the web, but you can run it locally if desired. To run it locally you must:
- Install [Node.js](nodejs.org)
- Clone the blog's [repository](https://github.com/etown-cs-homelab/etown-cs-homelab.github.io)
- Run the following:
```
npm install
npm start
```
There are no additional APIs that we're using to run this.
## Authors
